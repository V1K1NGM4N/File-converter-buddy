            ...
            <div className="space-y-8">
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div
                    className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-lg p-6 hover:shadow-lg hover:scale-[1.02] hover:border-primary/50 transition-all duration-200 cursor-pointer"
                    onClick={() => navigate('/blog/image-to-pdf-guide')}
                  >
                    <h3 className="text-lg font-semibold mb-2">Image to PDF Guide</h3>
                    <p className="text-muted-foreground text-sm mb-3">How to combine photos into a single document.</p>
                    <div className="flex items-center gap-2 text-xs text-muted-foreground">
